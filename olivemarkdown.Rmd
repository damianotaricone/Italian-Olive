...
ggplot(data = italy_data) +
  ...
  scale_fill_viridis_c(name = "Mean value of acido1") +
  labs(title = "Heatmap of acido1 in Italy by Region") +
  theme_minimal()
